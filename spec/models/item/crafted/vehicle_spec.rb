...
RSpec.describe Item::Crafted::Vehicle do
  let(:vehicle) { create(:vehicle_hover_bike) }
  ...
  describe 'travels' do
    ...
    it 'nil user protection' do
      expect { create(:vehicle_hover_bike).travel(location2) }.to raise_error(CraftyError)
    end
