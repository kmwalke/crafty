FactoryBot.define do
  factory :tool, class: ItemType::TYPES[:craftable_tool], parent: :item do
    sequence(:name) { |n| "Tool_#{n}" }
    sequence(:description) { |n| "This is the description for Tool_#{n}" }

    factory :craftable_tool_gathering_tool, class: ItemType::TYPES[:craftable_tool_gathering_tool] do
